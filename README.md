...
| [Brhiza/mingyu](https://github.com/Brhiza/mingyu) | 八字、紫微、星盘、六爻、梅花、奇门、大六壬、小六壬、塔罗、雷诺曼、灵签、择日一站式玄学算命占卜工具包，输出结构化提示词与数据。提供公开 API、MCP Server 与 skill。 | Starred | `0ba79b7bae12` |
...
| [THU-MAIC/OpenMAIC](https://github.com/THU-MAIC/OpenMAIC) | Open Multi-Agent Interactive Classroom — Get an immersive, multi-agent learning experience in just one click | Starred | `98765db8b336` |
| [zinan92/wechat-xingqiu](https://github.com/zinan92/wechat-xingqiu) | 将 Markdown / 本地 HTML 发布到微信会员内容产品。in 文档 + 图片 + 栏目 → out 电脑后台 + 手机管理 + 原生小程序阅读。HTML 常见样式与宽表格横滑，无需额外网站域名。 | Owned | `owned source` · PRIVATE |

### Fitness / 轻练 (3)

| Repo | Capability / description | Source | Lock / flags |
|---|---|---|---|
| [HammingDev/haiming-app-monetization](https://github.com/HammingDev/haiming-app-monetization) | 海明Dev： App 商业化 Skill｜onboarding、付费墙、内购选项、竞品调研 | Starred | `271d8abf34a4` |
| [hasaneyldrm/exercises-dataset](https://github.com/hasaneyldrm/exercises-dataset) | 1,324-exercise fitness dataset — animation GIFs, 180×180 thumbnails, muscle-group & equipment data, and step-by-step instructions in 6 languages. The exercise data layer behind the LogPress app. | Starred | `7455efae41b3` |
| [zinan92/get-fit](https://github.com/zinan92/get-fit) | 轻练 · 私教 30 天训练与饮食计划小程序 | Owned | `owned source` |
